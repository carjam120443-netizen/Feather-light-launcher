...
class MainActivity : Activity() {
    ...
    private fun selectedWallpaper(): android.graphics.drawable.Drawable {
        ...
        val res = when (name) { "blue" -> com.carjam.featherlightlauncher.R.drawable.feather_blue; "color" -> com.carjam.featherlightlauncher.R.drawable.feather_color; "aurora" -> com.carjam.featherlightlauncher.R.drawable.feather_aurora; "minimal" -> com.carjam.featherlightlauncher.R.drawable.feather_minimal; else -> com.carjam.featherlightlauncher.R.drawable.feather_midnight }
